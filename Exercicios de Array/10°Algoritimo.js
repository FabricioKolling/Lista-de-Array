...
let vetor = [12, 2, 3, 4, 5, 6, 7, 8, 9, 10]

numero = Number(prompt("Digite qual numero você quer saber se existe no vetor: "))

if(!vetor.includes(numero)){
    alert("Numero não existe pae")
}
else{
    alert("Aqui esta o indice do seu numero: "+ vetor.indexOf(numero))
}
